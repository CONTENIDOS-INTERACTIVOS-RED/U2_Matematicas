  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '2',
        titulo: 'Concepto de variable y expresión algebraica',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '2.1',
            titulo: 'Fundamentos de variables',
            hash: 't_2_1',
          },
          {
            icono: 'far fa-file-alt',
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Resolución de ecuaciones lineales sencillas',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.4',
            titulo: 'Aplicación del álgebra en la vida diaria',
            hash: 't_3_4',
          },
        ],
      },
